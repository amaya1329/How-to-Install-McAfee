...
Installing McAfee is easy, although it is a little different depending on the operating system you are running. Let's start by talking about how to install Windows.
  ...
  ▪  Get McAfee by buying it or downloading it
  ...
  ▪  If you have one, enter the product key
...
For Android Phones:
   ...
   ▪ Open the Google Play Store: On your Android device, open the Play Store.

   ▪  Find the McAfee Mobile Security app by typing "McAfee Mobile Security" into the search bar.

   ▪ Download the app: Press the "Install" button and wait for the program to download.

   ▪ Sign In or Register: After you install the app, open it and either sign in using your McAfee account or make a new one.
...
-------------
    ...
    ▪  To find McAfee Mobile Security, type "McAfee Mobile Security" into the search box.

    ▪  Get the app: To install the app on your device, tap "Get."

    ▪  Sign In or Register: After you install the app, open it and either sign in using your McAfee account or make a new one.

    ▪  Complete Setup: Follow the instructions to finish setting up and start protecting your device.
...
After you install and activate McAfee, you need to make sure you're using it to its full potential:
   ...
   ▪  Make Sure McAfee Is Up to Date: Always check to see that your McAfee software is up to date. The corporation frequently provides updates to correct security holes and make the software safer.

   ▪ Set up automatic scans to make sure your system is examined for threats on a regular basis without you having to run a scan every time.

   ▪  Check for Alerts: McAfee will let you know if there are any problems found during scans or if your subscription is set to end.
